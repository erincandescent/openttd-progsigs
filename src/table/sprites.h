...
static const SpriteID SPR_IMG_SIGNAL_ELECTRIC_PROG     = SPR_SIGNALS_BASE + 156; // HACK using PBS sprite, want own
...
static const SpriteID SPR_IMG_SIGNAL_SEMAPHORE_PROG    = SPR_SIGNALS_BASE + 220; // HACK using PBS sprite, want own
